...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleRoleNotFound(RoleNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
            .body(new ApiErrorResponse("role_not_found", "Role não existe"));
    }

    @ExceptionHandler(RoleCodeAlreadyExistsException.class)
    public ResponseEntity<ApiErrorResponse> handleRoleCodeAlreadyExists(RoleCodeAlreadyExistsException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(new ApiErrorResponse("role_code_already_exists"));
    }

    @ExceptionHandler(RoleInUseException.class)
    public ResponseEntity<ApiErrorResponse> handleRoleInUse(RoleInUseException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(new ApiErrorResponse("role_in_use"));
    }

    @ExceptionHandler(RoleProtectedException.class)
    public ResponseEntity<ApiErrorResponse> handleRoleProtected(RoleProtectedException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(new ApiErrorResponse("role_protected"));
    }

    @ExceptionHandler(RoleInactiveException.class)
    public ResponseEntity<ApiErrorResponse> handleRoleInactive(RoleInactiveException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(new ApiErrorResponse("role_inactive"));
    }
