...
public class ListRolesController {
    ...
    public ResponseEntity<ListRolesResponse> listRoles(@AuthenticationPrincipal AuthenticatedPrincipal principal) {
        ListRolesQuery query = new ListRolesQuery(principal.roles().contains("platform.admin"));
