...
import br.com.deltaglobalbank.identity.features.assignUserRole.AssignRolesResponse;
...
class AssignUserUseCaseTest {
    ...
    void shouldNotSaveWhenUserAlreadyHasTheRequestedRole() {
        ...
        UUID moduleId = UUID.randomUUID();
        RoleCode roleCode = new RoleCode("lending.viewer");
        Role existingRole = new Role(UUID.randomUUID(), roleCode, moduleId, null, Instant.now());
    ...
    void shouldAddOnlyTheMissingRoleWhenUserAlreadyHasOneOfTheRequestedRoles() {
        ...
        Role existingRole = new Role(UUID.randomUUID(), new RoleCode("lending.viewer"), moduleId, null, Instant.now());
        Role newRole = new Role(UUID.randomUUID(), new RoleCode("customers.viewer"), moduleId, null, Instant.now());
